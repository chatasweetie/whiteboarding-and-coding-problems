...
all_values = all_values_alpha_order(directionalgraph.graph_root_1)

directionalgraph.alpha.sort()
...
all_values_2 = all_values_alpha_order_v2(directionalgraph.graph_root_2)
...
if all_values == directionalgraph.alpha:
    print True
...
# Check out the code in solution at
# https://github.com/chatasweetie/Algorithms-Whiteboarding/tree/master/questions/graph_find_all_nodes_directional/solution/directionalgraph.py
